...
\begin{thm}
    ...
    \[ \left|\lambda\right| \leq r \quad \text{ for } \lambda\in\spec{\almostallones{N}{M}}\backslash\{\lambda_0\} \]
\end{thm}
...
\( \norm{X_{11}^o}, \norm{X_{22}^o} \)
(which are of particular interest, since they define the spectra)

\[ \norm{X_{11}^o}, \norm{X_{22}^o} \leq \frac{\beta}{N}(r_0 + 1) \]
