...
\begin{lemma}
    ...
    и, если \( r_0 \) посчитан на согласованной с \( \mathscr{X} \) матричной норме,
    для всех \( { \lambda\in\spec{A-B}\setminus\{\lambda_1\} } \) имеет место
    \[ \lvert\lambda\rvert \leq r_0. \]
\end{lemma}

Теперь требуемые результаты мы получим оценив \( \beta, \gamma \).

В ходе рассуждений полагалось, что в \( \matr{N}{} \) выбрана суб-мультипликативная норма,
а в \( \End{\matr{N}{}} \) используется обычная операторная норма.
Теперь будем считать, что и в \( \matr{N}{} \)
также выбрана операторная норма
