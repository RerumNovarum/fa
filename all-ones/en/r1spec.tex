...
% \begin{TRIVIA}
%         \[\frac{1-2\gamma\beta-\sqrt{1-4\gamma\beta}}{2\gamma^2\beta}
%             < \frac{1-2\gamma\beta}{2\gamma^2\beta}\]
%         \[1-2\gamma\beta-\sqrt{1-4\gamma\beta} < 1+1-4\gamma\beta\]
% %OLD:  \[-\gamma\beta<\sqrt{1-4\gamma\beta}\left(1+\sqrt{1-4\gamma\beta}\right)\]
%         which is true
% \end{TRIVIA}
